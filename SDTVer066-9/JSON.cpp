...
//  EEPROMData.freqIncrement = doc["freqIncrement"];
  ...
  for (int i = 0; i < EQUALIZER_CELL_COUNT; i++) EEPROMData.equalizerRec[i] = doc["equalizerRec"][i];
  for (int i = 0; i < EQUALIZER_CELL_COUNT; i++) EEPROMData.equalizerXmt[i] = doc["equalizerXmt"][i];
  ...
  for (int i = 0; i < NUMBER_OF_BANDS; i++) EEPROMData.powerOutCW[i] = doc["powerOutCW"][i];
  for (int i = 0; i < NUMBER_OF_BANDS; i++) EEPROMData.powerOutSSB[i] = doc["powerOutSSB"][i];
...
//  doc["freqIncrement"] = EEPROMData.freqIncrement;
  ...
  for (int i = 0; i < EQUALIZER_CELL_COUNT; i++) doc["equalizerRec"][i] = EEPROMData.equalizerRec[i];
  for (int i = 0; i < EQUALIZER_CELL_COUNT; i++) doc["equalizerXmt"][i] = EEPROMData.equalizerXmt[i];
  ...
  for (int i = 0; i < NUMBER_OF_BANDS; i++) doc["CWPowerCalibrationFactor"][i] = EEPROMData.CWPowerCalibrationFactor[i];
